...
class PostsServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreatePost = channel.unary_unary(
                ...
                request_serializer=posts__pb2.PostCreateRequest.SerializeToString,
                response_deserializer=posts__pb2.PostCreateResponse.FromString,
...
def add_PostsServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'CreatePost': grpc.unary_unary_rpc_method_handler(
                    servicer.CreatePost,
                    request_deserializer=posts__pb2.PostCreateRequest.FromString,
                    response_serializer=posts__pb2.PostCreateResponse.SerializeToString,
            ),
    }
...
class PostsService(object):
    ...
    def CreatePost(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/posts.PostsService/CreatePost',
            posts__pb2.PostCreateRequest.SerializeToString,
            posts__pb2.PostCreateResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
